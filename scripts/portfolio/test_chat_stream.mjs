...
test('rail includes only complete, allowed citations, in answer order', () => {
  const sources = [{ id:'a', url:'/#case=abc' }, { id:'b', url:'https://medium.com/@willdzierson/essay' }];
  const partial = '[Project](/#case=ab'; assert.deepEqual(citedSources(partial, sources), []);
