    ...
    <div className="lg:sticky lg:top-24 flex flex-col justify-between h-full">
      <div className="space-y-6">
        ...
        <div className={cn(
          ...
          <p>
            Let's chat. I built this AI version of my portfolio for fun. Ask it about my work or what I like to do, etc. With that in mind, it's an assistant. It's not meant to be a "copy" of me. It knows stuff about stuff, but it's main purpose is to help you explore.
          </p>
