...
import { PARTICLE_INK } from './journeySequence';
    ...
    <svg viewBox="0 0 640 600" preserveAspectRatio="xMidYMid meet">
      <defs>
        <pattern id={`${id}-lights`} width="181" height="193" patternUnits="userSpaceOnUse">
          {lights.map((light, i) => <circle key={i} cx={light.x} cy={light.y} r={light.r} fill={PARTICLE_INK} opacity={light.opacity}/>)}
        </pattern>
      ...
      <g fill="none" stroke={PARTICLE_INK} strokeWidth=".65" opacity=".19">
