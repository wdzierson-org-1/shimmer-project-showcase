...
export type PortfolioProject = { id: string; title: string; client: string; description: string; involvement: string | null; year: number | null; liveurl: string | null; unlisted: boolean; project_images: Media[]; tags: string[] };
